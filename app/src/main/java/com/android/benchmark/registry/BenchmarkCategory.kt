...
@IntDef([BenchmarkCategory.Companion.GENERIC, BenchmarkCategory.Companion.UI, BenchmarkCategory.Companion.COMPUTE])
internal annotation class BenchmarkCategory {
    companion object {
        var GENERIC = 0
        var UI = 1
        var COMPUTE = 2
